...
def process_image(image):
    blob = cv2.dnn.blobFromImage(
        image, size=(300, 300), swapRB=True, crop=False
    )
    
    pb  = 'src/frozen_inference_graph.pb'
    pbt = 'src\ssd_inception_v2_coco_2017_11_17.pbtxt'
...
curr_time += '.png'
save_image.save(f'images\{curr_time}')
